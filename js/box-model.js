...
function ClickbtnAvancarAgendamento(){
    ...
    $('.btn-avancar').click(function(){
        $('.modal-agenda-servicos').css('display','none');
        $('.login-agenda').fadeIn();
    })
